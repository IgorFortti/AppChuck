...
class HomeViewControllerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        viewController.screen.tableView = tableView
    ...
    func testConfigTableView() throws {
        XCTAssertTrue(viewController.screen.tableView.delegate is HomeViewController)
        XCTAssertTrue(viewController.screen.tableView.dataSource is HomeViewController)
    }
